    ...
    return (
        <NavigationContainer>
            <Tab.Navigator screenOptions={({ route }) => ({
                ...
                tabBarStyle: {
                    display: mostrarNavBar === "Resultado" || mostrarNavBar === "Autenticacao" || mostrarNavBar === "Perfil" || mostrarNavBar === "Registrar" || mostrarNavBar === "Login" || mostrarNavBar === "Instrucao" || mostrarNavBar === "Camera" || mostrarNavBar === "Anuncio" || mostrarNavBar === "DetalhesAnuncio" ? "none" : "flex",
                }
            })}>
                <Tab.Screen 
                    name="Home" 

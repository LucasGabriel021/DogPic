    ...
    return (
        <NavigationContainer>
            <Tab.Navigator screenOptions={({ route }) => ({
                ...
                tabBarStyle: {
                    display: mostrarNavBar === "Resultado" || mostrarNavBar === "Autenticacao" || mostrarNavBar === "Registrar" || mostrarNavBar === "Instrucao" || mostrarNavBar === "Camera" || mostrarNavBar === "Anuncio" || mostrarNavBar === "DetalhesAnuncio" ? "none" : "flex",
                }
            })}>
                <Tab.Screen 
                    name="Home" 
